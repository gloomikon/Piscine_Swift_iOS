...
Pod::Spec.new do |s|
    ...
    s.description      = <<-DESC
    Educational  project of Piscine Swift
    DESC
    s.homepage         = 'https://github.com/gloomikon/Piscine_Swift_iOS/tree/master/d08/mzhurba2019'
    ...
    s.social_media_url = 'https://twitter.com/gloomikon'
    
    s.ios.deployment_target = '8.0'
    
    s.source_files = 'mzhurba2019/Classes/**/*'
    s.resource = 'mzhurba2019/Assets/*'
    #s.resource_bundles = {'mzhurba2019' => ['mzhurba2019/*.xcdatamodeld']}
